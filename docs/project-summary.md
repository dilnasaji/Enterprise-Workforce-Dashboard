...
**Problem:** Raw 35-column flat CSV with no dates, no structure, constant columns, and a text-based attrition field.
...
### Page 1. Financial Risk View (e.g., taken from Manulife lens)
...
### Page 2. Tech Workforce View (e.g., taken from CGI lens)
...
### Page 3 — Strategic Advisory View (e.g., taken from Deloitte lens)
